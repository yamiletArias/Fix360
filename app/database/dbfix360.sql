...
CONSTRAINT uq_propietario_unico UNIQUE(idcliente,idvehiculo, fechainicio)
...
CREATE TABLE egresos (
  ...
  CONSTRAINT fk_egresos_compra FOREIGN KEY (idcompra) REFERENCES compras(idcompra),
...
idcolaborador 		INT 			NOT NULL,
idvehiculo 			INT 			NULL,
tipocom 			ENUM('boleta', 'factura','orden de trabajo') NOT NULL,
fechahora 			DATETIME 		DEFAULT 		CURRENT_TIMESTAMP,
numserie 			VARCHAR(10) 	NOT NULL,
numcom 				VARCHAR(10) 	NOT NULL,
moneda 				VARCHAR(20)		NOT NULL,
idexpediente_ot INT              NULL, 
