        ...
        <div class="mb-3 d-flex align-items-center">
          <label>
            <input class="form-check-input text-start" type="radio" name="tipo" value="persona"
              onclick="mostrarFormulario('persona')" checked>
            Persona
          </label>
          <label style="padding-left: 10px;">
            <input class="form-check-input text-start" type="radio" name="tipo" value="empresa"
          ...
          <div>
            <div class="row">
              ...
              <div class="col-md-2 mb-3">
                <div class="form-floating">
                  <input type="text" class="form-control input" name="numdoc" id="numdoc" minlength="8" maxlength="20"
                    placeholder="numdoc" autofocus required>
              ...
              <div class="col-md-4 mb-3">
                <div class="form-floating">
                  <input type="text" name="apellidos" class="form-control input" id="apellidos" minlength="2"
              ...
              <div class="col-md-4 mb-3">
                <div class="form-floating">
                  <input type="text" id="nombres" class="form-control input" name="nombres" minlength="2"
                    maxlength="100" required placeholder="nombrealazar">
              ...
              <div class="col-md-8 mb-3">
                <div class="form-floating">
                  <input type="text" class="form-control input" name="direccion" id="direccion" minlength="5"
                    maxlength="100" placeholder="mi casa">
              ...
              <div class="col-md-2 mb-3">
                <div class="form-floating">
                  <input type="text" id="telprincipal" class="form-control input" minlength="9" maxlength="9"
                    name="telprincipal" placeholder="celular">
              ...
              <div class="col-md-2 mb-3">
                <div class="form-floating">
                  <input type="text" id="telalternativo" name="telalternativo" class="form-control input" minlength="9"
                    maxlength="9" placeholder="956633983">
              ...
              <div class="col-md-8 mb-3">
                <div class="form-floating">
                  <input type="email" name="correo" class="form-control input" id="correo" minlength="10"
                    maxlength="100" placeholder="thepunisher2000@gmail.com">
              ...
              <div class="col-md-2 mb-3">
                <div class="form-floating">
                  <input type="text" name="numruc" class="form-control input" id="numruc" minlength="11" maxlength="11"
                    placeholder="N° RUC">
        ...
        <div id="formEmpresa" style="display: none;">
          <div>
            <div class="row">
              <div class="col-md-4 mb-3">
                <div class="form-floating">
                  <input type="text" id="ruc" name="ruc" class="form-control input" placeholder="rucdelaempresa"
              ...
              <div class="col-md-4">
                <div class="form-floating">
                  <input type="text" id="nomcomercial" name="nomcomercial" class="form-control input"
                    placeholder="nomcomercial" minlength="5" maxlength="100" required>
              ...
              <div class="col-md-4">
                <div class="form-floating">
                  <input type="text" id="razonsocial" name="razonsocial" class="form-control input"
                    placeholder="razonsocia0l" minlength="5" maxlength="100" required>
                  <label for="razonsocial"><strong>Razón Social</strong></label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating">
                  <input type="text" id="telempresa" name="telempresa" class="form-control input"
                    placeholder="telempresa" minlength="9" maxlength="9">
                  <label for="telempresa"><strong>Teléfono</strong></label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating">
                  <input type="email" id="correoemp" name="correoemp" class="form-control input" placeholder="coreoemp"
    ...
    <div class="modal-content">
      <form id="formNuevoServicio">
        ...
        <div class="modal-body">
          ...
          <div class="form-floating mb-3">
            <input type="text" id="modalServicioNombre" class="form-control input" placeholder="Nombre del servicio"
