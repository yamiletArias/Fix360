...
<div class="container-main mt-5">
    <div class="card border">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="listar-ventas.php" class="btn btn-sm btn-success">Mostrar Lista</a>
                <a href="#" id="btnToggleService" class="btn btn-sm btn-success">Agregar servicio</a>
            </div>
        </div>
        <div class="card-body">
            <form action="" method="POST" autocomplete="off" id="formulario-detalle">
                ...
                <div class="row g-2 mt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <select class="form-select" id="vehiculo" name="vehiculo" style="color:black;">
                                <option selected>Sin vehículo</option>
                            </select>
                    ...
                    <div class="col-md-3 d-flex">
                        ...
                        <!-- Botón para permitir fechas pasadas -->
    ...
    <div class="card mt-2 border">
        <div class="card-footer text-end">
            ...
            <div class="mt-4">
                ...
                <a href="" type="reset" class="btn btn-secondary" id="btnCancelarVenta">Cancelar</a>
            </div>
        </div>
    </div>
</div>
...
<!-- =========================== -->
<!-- Scripts específicos: Servicios -->
<!-- =========================== -->
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
  // 1) Mostrar sección de servicios
  document.getElementById('btnToggleService').addEventListener('click', function(e) {
    ...
    document.getElementById('ingresogrua').disabled   = false;
  });
  ...
  // 5) Inicializar campo fecha por defecto
