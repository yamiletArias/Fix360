...
?>
      <div class="container-main">
        <div class="form-group">
          ...
          <textarea style="margin-right: 200px; padding-right: 100px" disabled rows="10" cols="50" name="" id="">Observaciones del auto</textarea>
          <button onclick="window.location.href='listar-vehiculos.html'" style="margin-top: 130px; margin-left: 460px"
        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
          <div class="card" style="width: 18rem; position: relative;">
            <div class="form-floating">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXzvt_A5UQ3xFzsAKD-ufZy0jSFQjUcEmb5w&s"
