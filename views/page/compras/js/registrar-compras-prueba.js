document.addEventListener("DOMContentLoaded", function () {
    ...
    const manejarEscaneo = () => {
        ...
        fetch(`http://localhost/Fix360/app/controllers/Compra.controller.php?q=${encodeURIComponent(codigo)}&type=producto`)
            .then(r => r.json())
            .then(data => {
            ...
            fetch("http://localhost/Fix360/app/controllers/Compra.controller.php", {
                ...
                .then((json) => {
                    ...
                    if (json.status === "success") {
                        ...
                        Swal.fire(
                            "Error",
                            "No se pudo registrar la compra: " + (json.message || "Desconocido"),
                            "error"
                        );
                    }
                })
